  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 py-20 bg-white rounded-t-2xl shadow-xl">
      <div className="text-center mb-14">
        <h2 className="text-3xl md:text-4xl font-title font-bold text-gray-800">
          Alumni Kami
        </h2>
        <p className="text-gray-600 text-base mt-2 max-w-xl mx-auto font-body">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {alumniList.map((alumnus, index) => (
          ...
          >
            ...
            <blockquote className="font-quote text-md text-gray-700 leading-relaxed italic border-l-4 border-blue-300 pl-4">
              “{alumnus.testimonial}”
            </blockquote>
          </motion.div>
        ))}
